...
const RoomDetails = (props: { params: { slug: string } }) => {
  ...
  const calculateMinCheckoutDate = (): Date | undefined => {
    if (checkinDate) {
  ...
  const handleBookNowClick = async () => {
    ...
    if (checkinDate > checkoutDate)
      return toast.error("Check-in date should be earlier than check-out date");
    const numberOfDays = calculateNumOfDays();
